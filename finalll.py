...
# import date time library to get current time and date
from datetime import datetime, timedelta   
# this library is used to get current location
from geopy.geocoders import Nominatim    
# this library is used to get random number  
import random   
# this library is used for profiling                           
import cProfile                            
