...
'''
Below commands are used for profiling
'''

cProfile.run('Verify_OTP(otp)')
cProfile.run('Get_OTP()')
cProfile.run('second_dose_status()')
cProfile.run('second_dose_certificate(second_dose_date)')
